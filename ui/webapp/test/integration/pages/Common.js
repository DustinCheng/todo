sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/b1/ui/app", ".html");
		...
		return Opa5.extend("com.sap.b1.ui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/b1/ui/localService/mockserver"], function (mockserver) {
